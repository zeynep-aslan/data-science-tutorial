...
s = set(ali)
s  #her elemandan(harften) bir tane var
...
s.add("gelecege_git")
s  # {"gelecege_git", "gelecegi", "ile", "yazanlar"}  # ekledigin siradan bagimsiz ekleme islemini yapar

s.add("ile")
s  # var olan degeri eklemedi 

s.remove("ali")
s  # ali olmadigi icin hata verdi

s.discard("ali")  # ali yoksa hata dondurme, varsa sil

#Setler - Klasik Kume Islemleri                                        # buraya bak
...
# kumelerin farklarinin toplami
set1.symmetric_difference(set2)  # yukardaki 2 satirin toplami
...
a*b
# 2 farkli yontem, ciktilari ayni
...
sorted(sirasiz_liste, key = lambda x: x[1])  # tuple in 2.degerine gore kucukten buyuge siralama
